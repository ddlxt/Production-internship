...
API_KEY = "sk-2y7285m3DI6VqFuPPmFqBUJ3VRRyyC5kjhtEWI6rMeHkHXSX"  # 可同时填写多个API-KEY，用英文逗号分割，例如API_KEY = "sk-openaikey1,sk-openaikey2,fkxxxx-api2dkey3,azure-apikey4"
...
# 重新URL重新定向，实现更换API_URL的作用

API_URL_REDIRECT = {
    # OpenAI
    "https://api.openai.com/v1/chat/completions": "https://api.mctools.online/v1/chat/completions",
    "https://api.openai.com/v1/embeddings": "https://api.mctools.online/v1/embeddings",
...
# Claude API KEY
ANTHROPIC_API_KEY = "sk-kBpsE8u98W1A1FBeE6780211E5Fd42D8B4A8E9A74346D82c"
...
DOC2X_API_KEY = "sk-dx6a6h2ckbdjyu7ic43814hh12cgkm5y"
